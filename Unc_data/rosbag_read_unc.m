...
bag = rosbag("lmpcc_windsimplesim_nominal_model_plus_wind_2022-12-05-17-02-42.bag")
...
csvwrite(strcat('data3/','x_mat.csv'),x_mat);
csvwrite(strcat('data3/','y_mat.csv'),y_mat);
csvwrite(strcat('data3/','sigma_x_mat.csv'),sigma_x_mat);
csvwrite(strcat('data3/','sigma_y_mat.csv'),sigma_y_mat);
csvwrite(strcat('data3/','sigma_xy_mat.csv'),sigma_xy_mat);