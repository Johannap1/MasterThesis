...
bag = rosbag("lmpcc_simplesim_robust_no_GP_2023-01-22-15-37-26.bag")
%%
...
csvwrite(strcat('no_GP_xy_field/','x_mat.csv'),x_mat);
csvwrite(strcat('no_GP_xy_field/','y_mat.csv'),y_mat);
csvwrite(strcat('no_GP_xy_field/','sigma_x_mat.csv'),sigma_x_mat);
csvwrite(strcat('no_GP_xy_field/','sigma_y_mat.csv'),sigma_y_mat);
csvwrite(strcat('no_GP_xy_field/','sigma_xy_mat.csv'),sigma_xy_mat);
csvwrite(strcat('no_GP_xy_field/','slack_mat.csv'),slack_mat);
%%
